...
import { Sparkles, BedDouble, ChevronRight, X } from "lucide-react";
import RoomHeroSection from "./sections/RoomHeroSection";
import RoomAccommodation from "./sections/RoomAccommodation";
...
const sections = [
  { 
    ...
    label: "Hero Section", 
    icon: Sparkles, 
    description: "Main hero banner with sliding images", 
    badge: "Featured", 
  ...
  { 
    ...
    icon: BedDouble, 
    description: "Manage room accommodations and cards", 
    badge: "1", 
    component: RoomAccommodation 
  },
];
...
export default function RoomManager() {
  ...
  return (
    <div className="space-y-6">
      <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        <div>
          <h1 className="text-2xl font-bold text-slate-900">Room Page Sections</h1>
          <p className="mt-1 text-sm text-slate-500">
