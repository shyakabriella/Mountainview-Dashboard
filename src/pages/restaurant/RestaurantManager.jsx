...
import { Image, Utensils, ChevronRight, X } from "lucide-react";
import RestaurantHeroSection from "./sections/RestaurantHeroSection";
import RestaurantMenuSection from "./sections/RestaurantMenuSection";
...
const sections = [
  { 
    ...
    label: "Hero Section", 
    icon: Image, 
    description: "Hero banner with background image, title and breadcrumb", 
    badge: "1", 
    component: RestaurantHeroSection 
  },
  { 
    id: "menu", 
    label: "Menu Section", 
...
export default function RestaurantManager() {
  ...
  return (
    <div className="space-y-6">
      <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        <div>
          <h1 className="text-2xl font-bold text-slate-900">Restaurant Page Sections</h1>
          <p className="mt-1 text-sm text-slate-500">
